(* OASIS_START *)
(* DO NOT EDIT (digest: 9c1fe4bdb7db57388b7175dc7a41ecef) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("simple_pam", ["src/simple_pam"])];
     lib_c = [("simple_pam", "src/simple_pam", [])];
     flags =
       [
          (["oasis_library_simple_pam_cclib"; "link"],
            [
               (OASISExpr.EBool true,
                 S [A "-cclib"; A "-lpam"; A "-cclib"; A "-lresolv"])
            ]);
          (["oasis_library_simple_pam_cclib"; "ocamlmklib"; "c"],
