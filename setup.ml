...
(* OASIS_START *)
(* DO NOT EDIT (digest: b6a3f3325b64239914ae3a1c481a1cd5) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ocsimgr.ml"; })
            ];
     ...
     oasis_digest = Some "\023\188\142\"\248,\168\209U\012\134Wp\200\227\239";
     oasis_exec = None;
     oasis_setup_args = [];
     };;
